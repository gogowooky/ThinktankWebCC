...
/** foredit の幅。iPhone はアプリ幅の100%、その他は50%。 */
export function forEditAreaWidth(appWidth: number): number {
  return Math.round(appWidth * (isIPhone() ? 1 : 0.5));
}
