...
選択色          ,Default.TextEditor.Text.Selection.BgColor,#cba8ff     ,#c6e6c6ff   ,color   ,"^#[0-9a-fA-F]{6,8}$"
一致色          ,Default.TextEditor.Text.Occurrence.BgColor,#fff0fd     ,#aac6aaff   ,color   ,"^#[0-9a-fA-F]{6,8}$"
