...
背景色          ,TextEditor.Color.Background,#f5f5f5     ,#f5f5f5     ,color   ,"^#[0-9a-fA-F]{6,8}$"
文字色          ,TextEditor.Color.Text,#1e1e1e     ,#1e1e1e     ,color   ,"^#[0-9a-fA-F]{6,8}$"
選択色          ,TextEditor.Color.Selection,#cba8ff     ,#c6e6c6ff   ,color   ,"^#[0-9a-fA-F]{6,8}$"
一致色          ,TextEditor.Color.Occurrence,#fff0fd     ,#aac6aaff   ,color   ,"^#[0-9a-fA-F]{6,8}$"
