...
| 文書 | 内容 |
|---|---|
| [30 相談と課題の役割と参照範囲](30_相談と課題の役割と参照範囲.md) | ASK／TASK、Chatと課題のID対応、Thinktankの2アクション、類似課題検索 |
| [29 複数サブ課題候補と保留再開](29_複数サブ課題候補と保留再開.md) | 最大5件の候補を個別採用し、本人確認付きの保留・再開と再開メモを会話へ接続 |
...
最新の追加実装：[30 相談と課題の役割と参照範囲](30_相談と課題の役割と参照範囲.md)。
